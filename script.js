...
const questionBank = [
    ...
    // --- PHẦN 2: CÂU BỊ ĐỘNG (PASSIVE VOICE) - GHÉP TỪ ---
    // (Đã chuyển từ Rewrite sang Scramble để phù hợp với game)
    ...
    // --- PHẦN 3: CÂU BỊ ĐỘNG - TRẮC NGHIỆM ---
    ...
    // --- PHẦN 4: TÌM LỖI SAI (ERROR IDENTIFICATION) ---
    // (Đã format lại để hiện A, B, C, D rõ ràng)
    ...
    // --- PHẦN 6: BỊ ĐỘNG - TRẮC NGHIỆM (Tiếp) ---
    ...
    // --- PHẦN 7: CÂU ĐIỀU KIỆN & CÂU ƯỚC - TRẮC NGHIỆM ---
    ...
    // --- PHẦN 11: MỆNH ĐỀ QUAN HỆ (RELATIVE CLAUSES) ---
    ...
    // --- PHẦN 13: MỆNH ĐỀ QUAN HỆ - TRẮC NGHIỆM ---
    ...
    // --- PHẦN 15: MỆNH ĐỀ QUAN HỆ - TRẮC NGHIỆM (Tiếp) ---
    ...
    // --- PHẦN 17: CÂU TƯỜNG THUẬT (REPORTED SPEECH) - GHÉP TỪ ---
    ...
    // --- PHẦN 18: TƯỜNG THUẬT - TRẮC NGHIỆM ---
    ...
    // --- PHẦN 19: SẮP XẾP CÂU (REPORTED/RELATIVE) ---
    ...
    // --- PART: TAG QUESTIONS (CÂU HỎI ĐUÔI) - MCQ ---
    ...
    // --- PART: PHRASAL VERBS (CỤM ĐỘNG TỪ) - MCQ ---
    ...
    // --- PART: ERROR IDENTIFICATION (TÌM LỖI SAI - MIXED) ---
    ...
    // --- PART: SCRAMBLE (SẮP XẾP TỪ - MIXED) ---
    ...
    // --- PART: MORE MCQ MIXED (TRẮC NGHIỆM TỔNG HỢP) ---
    ...
    // --- PART: COMMUNICATION (GIAO TIẾP XÃ HỘI) - MCQ ---
    ...
    // --- PART: VOCABULARY - SYNONYMS (TỪ ĐỒNG NGHĨA) - MCQ ---
    ...
    // --- PART: VOCABULARY - ANTONYMS (TỪ TRÁI NGHĨA) - MCQ ---
    ...
    // --- PART: PHONETICS (TRỌNG ÂM & PHÁT ÂM) - MCQ ---
    // (Lưu ý: Game hiển thị text nên chọn dạng bài tìm từ khác biệt)
    ...
    // --- PART: CAUSATIVE FORM (THỂ SAI KHIẾN) - MCQ ---
    ...
    // --- PART: ADVANCED SCRAMBLE (SẮP XẾP CÂU NÂNG CAO) ---
    ...
    // --- PART: ERROR IDENTIFICATION (TÌM LỖI SAI NÂNG CAO) ---
    ...
    { type: 'error', q: "The man (A)whom (B)you met (C)him (D)yesterday is my uncle.", parts: ["whom", "you met", "him", "yesterday"], a: "him", full: "The man whom you met yesterday is my uncle." }, // Bỏ "him"

    // --- PART: MIXED GRAMMAR (NGỮ PHÁP TỔNG HỢP) - MCQ ---
